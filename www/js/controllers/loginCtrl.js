angular.module('app')
    .controller('loginCtrl', function($scope, $rootScope, $ionicHistory, sharedUtils, $state, $ionicSideMenuDelegate, SessionService, $firebaseObject, $firebaseArray, $window, $cordovaDevice, IonicPopupService, $cordovaOauth, $location,sharedCartService) {
